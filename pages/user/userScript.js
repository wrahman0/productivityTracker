...
function resetToZero(){
	for(c = 0; c < this.dailyHrs.length;c++){
		this.dailyHrs[c] = 0;
	}
}
...
function renderGrid(ctx){
	...
	// console.log(localStorage.getItem('monthArray'));
...
function buildGraph(month, color){
	...
	ctx.fillText(getName(JSON.parse(localStorage.getItem('monthArray'))[month]) +" "+ d.getFullYear(), canvas.width/2 - 120, 80);
...
/*
	...
	monthArray[d.getMonth()].dailyHrs[4] = 2.5; 
	monthArray[d.getMonth()].dailyHrs[6] = 2; 
	monthArray[d.getMonth()].dailyHrs[14] = 2; 
